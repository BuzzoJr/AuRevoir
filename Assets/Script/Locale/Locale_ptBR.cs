    ...
    public static class Locale_ptBR
    {
        public static readonly Dictionary<TextGroup, List<TextData>> Texts = new()
        {
            ...
            },
            {
                ...
                new List<TextData>()
                {
                    new TextData(TextType.TristanThinking, "Não posso usar isso aqui"),
                }
            },
            {
                TextGroup.Map,
            ...
            },
            {
                ...
                new List<TextData>()
                {
                    new TextData(TextType.TristanThinking, "Melhor não mexer nesses documentos."),
                    new TextData(TextType.TristanThinking, "Vai que ela me pede pra arrumar tudo depois."),
                }
            },
            {
                ...
                new List<TextData>()
                {
                    new TextData(TextType.TristanThinking, "A quantidade de casos está definitivamente diminuindo a cada dia."),
                }
            },
            {
            ...
            },
            {
                ...
                new List<TextData>()
                {
                    new TextData(TextType.TristanThinking, "O que isso está fazendo aqui?"),
                }
            },
            {
                ...
                {
                    new TextData(TextType.PoliceOfficer, "Precisa de alguma coisa?"),
                    new TextData(TextType.Tristan, "Teve quantas vítimas nesse acidente?"),
                    new TextData(TextType.PoliceOfficer, "Apenas o casal ali."),
                    new TextData(TextType.PoliceOfficer, "Você não vê que estou trabalhando aqui? Pode sair da frente agora?"),
                }
            },
            {
                ...
                new List<TextData>()
                {
                    new TextData(TextType.TristanThinking, "Sempre achei essa decoração um pouco exagerada."),
                }
            },
            {
                ...
                new List<TextData>()
                {
                    new TextData(TextType.TristanThinking, "Não estou com sede agora."),
                }
            },
            {
                ...
                new List<TextData>()
                {
                    new TextData(TextType.TristanThinking, "Esse prédio é tão alto que nem consigo ver o chão."),
                    new TextData(TextType.TristanThinking, "Me pergunto quantas pessoas trabalham na Au Revoir?"),
                }
            },
            {
                TextGroup.PoliceCar,
                new List<TextData>()
                {
                    new TextData(TextType.TristanThinking, "A polícia está cada vez mais no pé da Au Revoir."),
                    new TextData(TextType.TristanThinking, "Eles deveriam agradecer que agora eles conseguem interrogar os mortos."),
                    new TextData(TextType.TristanThinking, "Ainda sim, eles não gostam de como a gente interfere no trabalho deles."),
                }
            },
            {
            ...
            },
            {
                ...
                new List<TextData>()
                {
                    ...
                    new TextData("Casa"),
                    new TextData("Fronteira do Distrito"),
                }
            },
            {
        ...
        public static readonly Dictionary<ItemGroup, ItemData> Item = new()
        {
            ...
            {
                ItemGroup.Bottle,
                new ItemData(13, "Garrafa vazia", "Uma garrafa de cerveja vazia")
            },
            {
                ItemGroup.BottleGas,
